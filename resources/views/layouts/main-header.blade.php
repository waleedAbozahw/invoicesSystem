									...
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											<h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold">الاشعارات</h6>
                                                ...
                                                <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{route('MarkAsRead_all')}}">تعيين الكل كمقروء</a></span>
                                            </a>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">
											<h5 style="color: yellow;" id="notifications_count">
											الاشعارات غير المقروءه : {{ auth()->user()->unreadNotifications->count() }}
											</h5>
